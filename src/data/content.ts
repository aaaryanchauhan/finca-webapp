    ...
    recommendations: [
      {
        ...
        distance: 'On Request · Dedicated Staff',
      ...
      },
      {
        ...
        distance: 'On Request · In-Villa Spa',
      ...
      },
      {
        ...
        distance: 'On Request · Outdoor Deck',
      ...
      },
      {
        ...
        distance: 'On Request · Outdoor Audio',
      ...
      },
      {
        ...
        distance: 'On Request · Estate Curation',
      ...
      },
      {
        ...
        distance: 'On Request · Estate Gym',
    ...
    recommendations: [
      {
        id: 'ocio',
        name: 'OCIO',
        note: 'Approx. 34 minutes | Lunch or Dinner',
        distance: 'Approx. 34 minutes',
        quote: 'One of our favorite restaurants in Medellín and a great choice for either lunch or dinner. Creative cuisine, excellent ingredients, and a relaxed but sophisticated atmosphere.',
        image: '/photos/dining_area/dining_area_01.jpeg',
      },
      {
        id: 'sambombi',
        name: 'Sambombi Bistró Local',
        note: 'Approx. 37 minutes | Dinner',
        distance: 'Approx. 37 minutes',
        quote: 'A small, intimate restaurant in Provenza focused on local ingredients and creative Colombian cuisine. A great choice for a special dinner.',
        reservations: 'Reservations are highly recommended for dinner.',
        image: '/photos/dining_area/dining_area_02.jpeg',
      },
      {
        id: 'mamba-negra',
        name: 'Mamba Negra',
        note: 'Approx. 41 minutes | Dinner',
        distance: 'Approx. 41 minutes',
        quote: 'Come for dinner and stay for the atmosphere. Located high above Medellín, Mamba Negra has a spectacular view of the city, great cocktails, and a beautiful setting. This is an excellent choice for a night out in Medellín.',
      ...
      },
      {
        ...
        note: 'Approx. 50 minutes | Lunch',
        distance: 'Approx. 50 minutes',
        quote: 'A great Italian option for lunch, known for its fresh pastas, breads, pizzas, and Italian-inspired dishes. Perfect for a relaxed afternoon meal.',
        image: '/photos/dining_area/dining_area_03.jpeg',
      },
      {
        id: 'bulgatta',
        name: 'Bulgatta',
        note: 'Approx. 40 minutes | Lunch',
        distance: 'Approx. 40 minutes',
        quote: 'A great lunch option and an opportunity to combine your meal with a little sightseeing. On the way there or back, stop at Salto del Tequendamita, a beautiful natural waterfall near El Retiro. It makes for a great half-day outing from the finca.',
        image: '/photos/dining_area/dining_area_04.jpeg',
      },
      {
        id: 'zelavi',
        name: 'Zelavi',
        note: 'Approx. 5 minutes',
        distance: 'Approx. 5 minutes',
        quote: 'One of the closest recommendations to Finca Libia and a great nearby option.',
        bestTimes: [
          'Dinner — Thursday, Friday, or Saturday',
          'Brunch — Sunday',
        ],
      ...
      },
      {
        id: 'don-diablo',
        name: 'Don Diablo',
        note: 'Approx. 35 minutes | Steakhouse',
        distance: 'Approx. 35 minutes',
        quote: 'One of Medellín’s standout steakhouses, specializing in Colombian beef, including dry-aged cuts prepared over a wood-fired grill. A great choice for steak lovers.',
        image: '/photos/dining_area/dining_area_07.jpeg',
      },
      {
        id: 'capitulo',
        name: 'Capítulo',
        note: 'Approx. 11 minutes | Dinner',
        distance: 'Approx. 11 minutes',
        quote: 'A convenient dinner option close to Finca Libia. Perfect when you want to go out for the evening without making the longer drive into Medellín.',
        image: '/photos/dining_area/dining_area_03.jpeg',
      },
      {
        id: 'el-rancherito',
        name: 'El Rancherito',
        note: 'Approx. 7 minutes | Lunch',
        distance: 'Approx. 7 minutes',
        quote: 'For a taste of traditional Antioquian food, this is one of the easiest recommendations. Come hungry and try some of the local classics. A great casual lunch close to Finca Libia.',
        image: '/photos/dining_area/dining_area_05.jpeg',
      },
    ],
  },
  {
    ...
    recommendations: [
      ...
      },
      {
        ...
        actionText: 'Ask me and I’ll recommend one depending on the night you’d like to go.',
      ...
      },
      {
        ...
        actionText: 'If you would like to visit Guatapé, ask me for details. I’ll be happy to help you organize the day.',
